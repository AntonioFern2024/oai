...
void nr_rrc_mac_config_req_sib19_r17(module_id_t module_id, NR_SIB19_r17_t *sib19_r17)
{
  ...
  if (ephemeris_info && position_velocity
    ...
    mac->ntn_ta.N_UE_TA_adj =
        calculate_ue_sat_ta(get_position_coordinates(module_id), mac->sc_info.ntn_Config_r17->ephemerisInfo_r17->choice.positionVelocity_r17);
  }
  ...
  if (sib19_r17->ntn_Config_r17->ta_Info_r17) {
    ...
    if (sib19_r17->ntn_Config_r17->ta_Info_r17->ta_CommonDrift_r17)
      mac->ntn_ta.ntn_ta_commondrift = *sib19_r17->ntn_Config_r17->ta_Info_r17->ta_CommonDrift_r17 * 0.2e-3;
  }
}
