                                                       ...
                                                       uint8_t *end)
{
  ...
  if (num_symbols > 0) {
    srsParameters->symbol_list = calloc(num_symbols, sizeof(*srsParameters->symbol_list));
  }
                                   ...
                                   nfapi_p7_codec_config_t *config)
{
  ...
  if ((value->pduBitmap >> 1) & 0x01) { // HARQ
    ...
    value->harq.harq_payload = calloc(((value->harq.harq_bit_len / 8) + 1), sizeof(*value->harq.harq_payload));
  ...
  if ((value->pduBitmap >> 2) & 0x01) { // CSI-1
    ...
    value->csi_part1.csi_part1_payload =
        calloc(((value->csi_part1.csi_part1_bit_len / 8) + 1), sizeof(*value->csi_part1.csi_part1_payload));
  ...
  if ((value->pduBitmap >> 3) & 0x01) { // CSI-2
    ...
    value->csi_part2.csi_part2_payload =
        calloc((value->csi_part2.csi_part2_bit_len / 8) + 1, sizeof(*value->csi_part2.csi_part2_payload));
                                         ...
                                         nfapi_p7_codec_config_t *config)
{
  ...
  if (value->pduBitmap & 0x01) { // SR
    ...
    value->sr.sr_payload = calloc((value->sr.sr_bit_len / 8) + 1, sizeof(*value->sr.sr_payload));
